...
const TransactionBulkCreatePage = lazy(
  () => import("@/pages/transactions/bulk-create"),
);
  ...
  [
    {
      ...
      children: [
        ...
        { path: "categories", element: withSuspense(CategoriesPage) },
        {
          ...
          element: withSuspense(CategoryCreatePage),
        },
        {
          path: "categories/:id/edit",
          element: withSuspense(CategoryEditPage),
        },
        { path: "currencies", element: withSuspense(CurrenciesPage) },
        {
          path: "currencies/create",
          element: withSuspense(CurrencyCreatePage),
        },
        {
          path: "currencies/:id/edit",
          element: withSuspense(CurrencyEditPage),
        },
        ...
        { path: "recurring", element: withSuspense(RecurringPage) },
        {
          ...
          element: withSuspense(RecurringCreatePage),
        },
        {
