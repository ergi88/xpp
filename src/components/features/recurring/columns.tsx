...
export const createRecurringColumns = ({
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const label =
        interval === 1 ? freq : `Every ${interval} ${freq.toLowerCase()}`;
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This action cannot be undone. This recurring transaction
                      will be permanently deleted. Existing transactions created
